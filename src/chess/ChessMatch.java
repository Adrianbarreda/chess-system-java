...
public class ChessMatch {
	...
	public ChessPiece performChessMove(ChessPosition sourcePosition, ChessPosition targetPosition) {
		...
		validateSourcePosition(source); // responsible for validating the origin position (does or not have a piece) if
										// it doesn't exist it will throw an exception
	...
	private Piece makeMove(Position source, Position target) {
		// Piece p = board.removePiece(source); //remove the piece that was in the
		// original position
